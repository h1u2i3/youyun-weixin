...
class DoctorsController < ApplicationController
  ...
  wechat_responder appid: APP_CONFIG['wechat_doctor']['appid'],
                   secret: APP_CONFIG['wechat_doctor']['secret'],
                   token: APP_CONFIG['wechat_doctor']['token'],
                   access_token: APP_CONFIG['wechat_doctor']['access_token']
