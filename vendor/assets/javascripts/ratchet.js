...
!(function () {
  ...
  var onTouchMove = function (e) {
    ...
    // offsetY = (deltaY / resistance) + getScroll();
    ...
    // resistance = slideNumber === 0         && deltaY > 0 ? (pageY / sliderWidth) + 1.25 :
                //  slideNumber === lastSlide && deltaY < 0 ? (Math.abs(pageY) / sliderWidth) + 1.25 : 1;

    slider.style.webkitTransform = 'translate3d(' + offsetX + 'px,0,0)';
    // slider.style.webkitTransform = 'translate3d(' + offsetY + 'px,0,0)';
  };
  ...
  var onTouchEnd = function (e) {
    ...
    setSlideNumber(
      ...
      // (+new Date()) - startTime < 1000 && Math.abs(deltaY) > 15 ? (deltaX < 0 ? -1 : 1) : 0
    );

    offsetX = slideNumber * sliderWidth;
    // offsetY = slideNumber * sliderWidth;
